<?php
/**
 * Autoloader for BookingX User Profiles Advanced.
 *
...
spl_autoload_register(
	function ( $class ) {
		...
		$file = BKX_USER_PROFILES_PATH . 'src/' . str_replace( '\\', '/', $relative_class ) . '.php';
...
$sdk_autoload = dirname( BKX_USER_PROFILES_PATH ) . '/_shared/bkx-addon-sdk/src/autoload.php';
