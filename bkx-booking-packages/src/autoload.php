<?php
/**
 * Autoloader for BookingX Booking Packages.
 *
...
spl_autoload_register(
	function ( $class ) {
		...
		$file = BKX_PACKAGES_PATH . 'src/' . str_replace( '\\', '/', $relative_class ) . '.php';
...
$sdk_autoload = dirname( BKX_PACKAGES_PATH ) . '/_shared/bkx-addon-sdk/src/autoload.php';
